...
func TestSearchTransactionsAfter(t *testing.T) {
	...
	t.Run("filter last block", func(t *testing.T) {
		...
		require.Equal(common.HexToAddress("0x703c4b2bD70c169f5717101CaeE543299Fc946C7"), results.Receipts[0]["from"].(accounts.Address))
		...
		require.Equal(common.HexToAddress("0x0D3ab14BBaD3D99F4203bd7a11aCB94882050E7e"), results.Receipts[1]["from"].(accounts.Address))
