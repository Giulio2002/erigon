...
func TestSearchTransactionsBefore(t *testing.T) {
	...
	t.Run("filter last block", func(t *testing.T) {
		...
		require.Equal(common.HexToAddress("0x0D3ab14BBaD3D99F4203bd7a11aCB94882050E7e"), results.Receipts[0]["from"].(accounts.Address))
		...
		require.Equal(common.HexToAddress("0x71562b71999873DB5b286dF957af199Ec94617F7"), results.Receipts[1]["from"].(accounts.Address))
